...
export function AuthModal({ isOpen, onClose, onSuccess }: AuthModalProps) {
  ...
  const handleSignIn = async (e: React.FormEvent) => {
    ...
    const { user, error } = await signInWithEmail(signInForm.email, signInForm.password);
  ...
  const handleSignUp = async (e: React.FormEvent) => {
    ...
    const { user, error } = await signUpWithEmail(signUpForm.email, signUpForm.password, signUpForm.displayName);
    ...
    <Dialog open={isOpen} onOpenChange={(open) => {
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Sign in or create an account to vote on videos and access personalized features.
          </DialogDescription>
        </DialogHeader>
